...
Then the output FastQ files are transferred securely to [UPPMAX](http://www.uppmax.uu.se/),
...
Finally data is transferred to the UPPMAX storage cluster **GRUS** or
the **Data Delivery System (DDS)** from which users may download the data.
