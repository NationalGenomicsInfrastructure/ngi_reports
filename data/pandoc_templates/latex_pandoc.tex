...
\pagestyle{fancy}
\lhead{\includegraphics[width=5cm]{../assets/SLL_logo.png}\vspace{0.3cm}}
\rhead{\includegraphics[width=5cm]{../assets/NGI_logo.png}\vspace{0.45cm}}
...
%%% Style the description items (definition lists)
\usepackage{enumitem}
...
% Hide the figure captions
\usepackage{caption}
\captionsetup{labelformat=empty,textformat=empty, skip=-1.5cm}
