...
\pagestyle{fancy}
\lhead{\includegraphics[width=5cm]{$template_dir$/assets/SLL_logo.png}\vspace{0.3cm}}
\rhead{\includegraphics[width=5cm]{$template_dir$/assets/NGI_logo.png}\vspace{0.45cm}}
